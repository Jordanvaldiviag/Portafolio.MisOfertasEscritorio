...
import portafolio.misofertasescritorio.products.*;
 ...
 * @author Acer
 */
public final class PopupDeleteOffers extends javax.swing.JFrame {

    /**
     * Creates new form PopupDeleteOffers
     */
    public PopupDeleteOffers() {
        initComponents();
        CargarComponentes();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¿Esta seguro de eliminar la Oferta?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupDeleteOffers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupDeleteOffers().setVisible(true);
            }
        });
    }
