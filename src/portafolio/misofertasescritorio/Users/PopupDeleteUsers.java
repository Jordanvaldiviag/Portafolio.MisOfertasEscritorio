 ...
 * @author Acer
 */
public final class PopupDeleteUsers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¿Esta seguro de eliminar el Usuario?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupDeleteUsers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new PopupDeleteUsers().setVisible(true);
        });
    }
    ...
    public void CargarDatos(){
        ...
        for (int i = 0; i < listaUsuarios.size(); i++) {
            if (idUsuario == listaUsuarios.get(i).getIDUsuario()) {
                lblUsuario.setText(listaUsuarios.get(i).getNombre());
            }
        }
    }
